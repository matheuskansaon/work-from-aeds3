...
class EnergiaCarta extends Carta{
    ...
    String tipoEnergia;//Indica o tipo de energia que esta carta fornece.Ex: Fogo(Fire),Água(Water),Especial(Special),dentre outras.
    String efeito;//Indica o efeito especial da energia,caso seja uma energia especial.senão,este campo fica vazio.
    ...
    EnergiaCarta(byte[] arr,int identificacao){
        super(arr,identificacao);
        try{
        ByteArrayInputStream bais = new ByteArrayInputStream(arr);
        DataInputStream dis = new DataInputStream(bais);
        SimpleDateFormat sdf = new SimpleDateFormat("dd MMM,yyyy",Locale.US);
        tipoEnergia = dis.readUTF();
        nome = dis.readUTF();
    ...
    */
    public void mostrar(){
        SimpleDateFormat sdf = new SimpleDateFormat("dd MMM,yyyy",Locale.US);
        System.out.println("ID: "+ id + " / Tipo de energia: " + tipoEnergia);
    ...
    */
    public byte[] modificar(Scanner s) throws IOException{
        ...
        do{
            ...
            System.out.println("1 - Tipo de energia da carta:");
            ...
            switch(escolha){
                case 1:
                System.out.println("Tipo de energia atual: " + tipoEnergia);
                System.out.println("Digite um novo tipo de energia(String)");
                tipoEnergia = s.nextLine();
                break;
                case 2:
